...
const StudentProgressMetrics = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-medium">GitHub Active Students</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold">{metrics.githubActiveStudents}</div>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-medium">LeetCode Active Students</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold">{metrics.leetcodeActiveStudents}</div>
          <p className="text-xs text-muted-foreground">
    ...
    <Card>
    <CardHeader>
      <CardTitle className="text-sm font-medium">Top LeetCode Performers</CardTitle>
    </CardHeader>
    <CardContent>
  ...
  <Card>
    <CardHeader>
      <CardTitle className="text-sm font-medium">Top GitHub Contributors</CardTitle>
    </CardHeader>
    <CardContent>
